...
from .backbone_main import build_backbone
from .transformer import LocalFeatureTransformer
from .fine_preprocess import FinePreprocess
from .coarse_matching import CoarseMatching
from .fine_matching import FineMatching

# Inline detect_NaN to remove dependency on ..utils.misc
def detect_NaN(feat_c0, feat_c1):
    # Simple NaN detection and warning
    if torch.any(torch.isnan(feat_c0)):
        print("Warning: NaN detected in feat_c0")
    if torch.any(torch.isnan(feat_c1)):
        print("Warning: NaN detected in feat_c1")
